...
SELECT ENNAME,EXTTEXT2,EXTTEXT4,EXTTEXT5,EXTTEXT6,EXTTEXT7,EXTTEXT8,EXTTEXT9,EXTTEXT10,EXTINT1 FROM BO_ACT_DICT_KV_ITEM WHERE DICTKEY= 'DCC_BASE.ALLDYSYSTABLE' AND ISACTIVE= 1 AND EXTTEXT2 IN('BO_EU_DCC_DZZ_INFO_BC') ORDER BY ORDERINDEX DESC


SELECT BINDID FROM BO_EU_DCC_DZZ_INFO  WHERE ORGANID='9138c56fd8704010a8fe4e37294adcb3' AND DCCBELONGSCHEME='AH_JIXI'
