...
SELECT ORG_NAME,SUBJECT_NAME,SUBJECT_CODE FROM BO_EU_FM_BUDGET_DATA WHERE YEAR= '$getForm(YEAR)' AND ORG_CODE= '$getForm(ORG_CODE)' ORDER BY SUBJECT_CODE
	...
	![enter description here](https://www.github.com/only-wjt/images/raw/master/小书匠/1551859576038.png)
	
	中共安徽省直属机关工作委员会  42条
	
	中共安徽省直属机关工作委员会 8910条
	
	中共安徽省委教育工作委员会 6948条
	
	国有企业和非公企业有
	
	农村街道社区![enter description here](https://www.github.com/only-wjt/images/raw/master/小书匠/1551863416068.png)
