...
SELECT ORG_NAME,SUBJECT_NAME,SUBJECT_CODE FROM BO_EU_FM_BUDGET_DATA WHERE YEAR= '$getForm(YEAR)' AND ORG_CODE= '$getForm(ORG_CODE)' ORDER BY SUBJECT_CODE
	...
	SELECT SUBJECT_NAME, SUBJECT_CODE FROM BO_EU_FM_FINANCE_SUBJECT WHERE SUBJECT_LEVEL = '3' AND ( '$getForm(PROJECT_NAME)' = '' AND '$getForm(PROJECT_NO)' = '' AND SUBJECT_TYPE = '1' ) OR SUBJECT_LEVEL = '3' AND ( '$getForm(PROJECT_NAME)' != '' AND '$getForm(PROJECT_NO)' != '' AND SUBJECT_TYPE = '2' ) ORDER BY SUBJECT_CODE