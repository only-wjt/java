...
发票管理出了刚录入，其他状态不能修改
!@if(@or(@equals(obj_7da6a2b4089a4a5489020623b7e863a0,@activityDefId),@equals(obj_ae7667bd7f4c4f24ae3d7deda4c9d754,@activityDefId)),@orgTpye,@form(BO_EU_FM_BORROW,PAY_DATE))
...
@form(BO_EU_FM_BORROW,USER_NAME)发起的借款申请流程，申请单号【@form(BO_EU_FM_BORROW,APPLY_NO)】由【@userName】【@date】发起的日常资金支付申请流程