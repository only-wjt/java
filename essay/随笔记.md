...
## 发票管理出了刚录入，其他状态不能修改
	...
	SELECT INVOICE_CODE,INVOICE_NO,INVOICE_DATE,CUSTMER_NAME,AMOUNT,TAX_AMOUNT,TOTAL_AMOUNT FROM BO_EU_FM_INVOICE_DATA WHERE INVOICE_STATUS='0' AND USER_NAME = 'getForm(USER_NAME)' AND BALANCE_TYPE = '1' ORDER BY INVOICE_CODE DESC