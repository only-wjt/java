...
---
	...
	* [单例模式定义：](#单例模式定义)
		...
		* [线程安全的问题](#线程安全的问题)
		* [单例模式的选择](#单例模式的选择)
		* [Spring中的单例模式详细请见同目录下的spring's singleton](#spring中的单例模式详细请见同目录下的springs-singleton)
	* [实现单例模式的方式](#实现单例模式的方式)
		* [饿汉式单例（立即加载方式）](#饿汉式单例立即加载方式)
		* [懒汉式单例（延迟加载方式）](#懒汉式单例延迟加载方式)
		* [静态内部类实现](#静态内部类实现)
		* [static静态代码块实现](#static静态代码块实现)
		* [内部枚举类实现](#内部枚举类实现)
